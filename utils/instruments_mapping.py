...
"""
General MIDI instrument mappings and high-level instrument classes
used by the Streamlit interface for instrument selection.
"""

# Program number -> human-readable instrument name
INSTRUMENTS = {
    -1: "Drums",
